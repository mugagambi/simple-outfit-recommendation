...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Edit Daily Weather</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('weather.update', ['weather' => $weather->id]) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           name="place" value="{{$weather->place}}" required autofocus>
                                    @if ($errors->has('place'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           name="place_short_code" value="{{$weather->place_short_code}}" required
                                           autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="date"
                                           ...
                                           name="day" value="{{\Carbon\Carbon::parse($weather->day)->toDateString()}}"
                                           required autofocus>
                                    @if ($errors->has('day'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="number"
                                           ...
                                           name="temperature" value="{{$weather->temperature}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="number"
                                           ...
                                           name="precipitation" value="{{$weather->precipitation}}" required autofocus>
                                    <small id="emailHelp" class="form-text text-muted">%</small>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="number"
                                           ...
                                           name="wind" value="{{$weather->wind}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="number"
                                           ...
                                           name="humidity" value="{{$weather->humidity}}" required autofocus>
                                    <small id="emailHelp" class="form-text text-muted">%</small>
